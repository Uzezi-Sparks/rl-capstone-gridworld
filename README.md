...
### V1 — Dynamic Programming Foundation
- Pursuit–Evasion GridWorld
...
Branch: `v2-model-free`

---

### V3 — Optimization & Validation

Current V3 work explores:
...
Active branch: `v3-optimization`

Detailed implementation: `README_v3.md`
